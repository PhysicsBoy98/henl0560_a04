...
public class TreeNode<T extends Comparable<T>> {
	...
	/**
	 * Returns this TreeNode data. Not copy safe as it returns a reference to the
	...
	/**
	 * Returns a DataCountPair version of the node. This contains only the data and
	 * count, and not the links to child nodes.
	 *
	 * @return A new DataCountPair object.
	 */
	public DataCountPair<T> getDataCountPair() {
		return new DataCountPair<>(this.data, this.count);
	}
	 ...
	 * child nodes. Empty child nodes have a height of 0.
	 */
