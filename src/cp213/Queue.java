...
public class Queue<T> extends SingleLink<T> {
     ...
     * Queue. Moves nodes only - does not move data or call the high-level
    ...
    /**
     * Returns the front data of the queue and removes that data from the queue.
     * The next node in the queue becomes the new first node. Decrements the
     * queue size.
     *
